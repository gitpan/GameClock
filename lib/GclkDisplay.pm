...
sub display {
  ...
  #  my $wmv='W' ;
  #  my $bmv='B' ;
  my  $white_mv=$fr->Button( -textvariable=>\$whites->[0]{mvt},
			     -foreground=>'yellow',
			     -font=>' Arial 24 bold',
  ...
  map{$mw->bind("<KeyPress-$_><KeyRelease-$_>",['GclkCounter::capture', 'B1-'])}(qw/a z e r t y q s d f g < w x c v b/) ;
  map{$mw->bind("<KeyPress-$_><KeyRelease-$_>",['GclkCounter::capture', 'B3-'])}(qw/u i o p Multi_key $ j k l m ugrave * n comma ; : \/ ! /) ;
